...
public class NewDeviceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        @SuppressLint({"MissingInflatedId", "LocalSuppress"}) TextView btReadings = findViewById(R.id.btReadings);
        @SuppressLint({"MissingInflatedId", "LocalSuppress"}) TextView btDevices = findViewById(R.id.btDevices);
        @SuppressLint({"MissingInflatedId", "LocalSuppress"}) Button connectToDevice = (Button) findViewById(R.id.connectToDevice);
        @SuppressLint({"MissingInflatedId", "LocalSuppress"}) Button seachDevices = (Button) findViewById(R.id.seachDevices);
        @SuppressLint({"MissingInflatedId", "LocalSuppress"}) Button clearValues = (Button) findViewById(R.id.refresh);
